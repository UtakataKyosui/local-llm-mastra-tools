...
Only state facts supported by the pages you fetched. If a tool returns an error, tell the user what failed instead of answering from memory. Say so clearly when information could not be found or sources disagree.`,
